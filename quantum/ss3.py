...
compute_ss3_y3(qc, qr_in, qr_out, anc)
qc.barrier()
compute_ss3_y2(qc, qr_in, qr_out, anc)
qc.barrier()
compute_ss3_y1(qc, qr_in, qr_out, anc)
qc.barrier()
compute_ss3_y0(qc, qr_in, qr_out, anc)

qc.draw(output='mpl', filename='ss3.png', fold=30)
...
tt = [0xa, 0x2, 0x6, 0xd, 0x3, 0x4, 0x5, 0xe, 0x0, 0x7, 0x8, 0x9, 0xb, 0xf, 0xc, 0x1]
