...
compute_ss0_y3(qc, qr_in, qr_out, anc)
qc.barrier()
compute_ss0_y2(qc, qr_in, qr_out, anc)
qc.barrier()
compute_ss0_y1(qc, qr_in, qr_out, anc)
qc.barrier()
compute_ss0_y0(qc, qr_in, qr_out, anc)

qc.draw(output='mpl', filename='ss0.png', fold=30)
...
tt = [0xe, 0x6, 0xc, 0xa, 0x8, 0x7, 0x2, 0xf, 0xb, 0x1, 0x4, 0x0, 0x5, 0x9, 0xd, 0x3]
